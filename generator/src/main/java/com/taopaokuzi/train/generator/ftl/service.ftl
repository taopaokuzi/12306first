package com.taopaokuzi.train.${module}.service;
...
import com.taopaokuzi.train.${module}.domain.${Domain};
import com.taopaokuzi.train.${module}.domain.${Domain}Example;
import com.taopaokuzi.train.${module}.mapper.${Domain}Mapper;
